...
<br/>
                <!-- Example table -->
                <div class="module">
                	<h2><span><?php echo __("Список отзывов",null); ?></span></h2>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($lang_count as $key => $langs) : $key++;?> 
                                              <?php if ($key == '1'): ?>                                    
                                                    <td><a href="<?php echo URL::base(TRUE,TRUE).'admin/testimonials/'.$material['id'].'-m/edit';?>"><?php echo $material['name_'.$langs.'']; ?></a></td>
                                              <?php else: ?> 
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/testimonials/'.$material['id'].'-m/edit';?>"><img src="<?php echo URL::base().'html/admin/images/pencil.gif"'; ?>" width="16" height="16" /></a>
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/testimonials/'.$material['id'].'-m/remove';?>"><img src="<?php echo URL::base().'html/admin/images/cross-on-white.gif"'; ?>" width="16" height="16" /></a>
                                        </td>
                                    </tr>
                                <?php 
                                    endforeach;
