...
<br/>
                <!-- Example table -->
                <div class="module">
                	<h2><span><?php echo __("Список баннеров",null); ?></span></h2>
                           ...
                           if ($menu_elements):
                            foreach ($menu_elements as $material) :?>
                                <tr>
                                    ...
                                    <?php foreach ($lang_count as $key => $langs) : $key++;?> 
                                          <?php if ($key == '1'): ?>                                    
                                                <td><a href="<?php echo URL::base(TRUE,TRUE).'admin/Banner/'.$material['id'].'-m/edit';?>"><?php echo $material['name_'.$langs]; ?></a></td>
                                          <?php else: ?> 
