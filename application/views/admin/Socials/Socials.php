...
<div class="float-right">
    <a class="button" href="<?php echo URL::base(TRUE,TRUE).'admin/socials/add'; ?>">
<span>
...
<br/>
                <!-- Example table -->
                <div class="module">
                	<h2><span><?php echo __("Список сервисов",null); ?></span></h2>
                    ...
                    <div class="module-table-body">
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    <th style="width:5%;">#</th>                                  
                                    <th style="width:21%"><?php echo __("Название",null); ?></th>                                    
                                    <th style="width:5%"><?php echo __("Url",null); ?>&nbsp;&nbsp;&nbsp;</th>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/socials/'.$material['id'].'-m/edit';?>"><img src="<?php echo URL::base().'html/admin/images/pencil.gif"'; ?>" width="16" height="16" /></a>
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/socials/'.$material['id'].'-m/remove';?>"><img src="<?php echo URL::base().'html/admin/images/cross-on-white.gif"'; ?>" width="16" height="16" /></a>
                                        </td>
                                    </tr>
                                <?php 
                                    endforeach;
