...
<div class="float-right">
    <a class="button" href="<?php echo URL::base(TRUE,TRUE).'admin/materials/add'; ?>">
<span>
...
<!-- Example table -->
<div class="module">
	<h2><span><?php echo __("Список материалов",null); ?></span></h2>
        ...
        <table id="myTable" class="tablesorter">
        	<thead>
                <tr>
                    ...
                    <?php endforeach; ?>                                      
                    <th style="width:20%"><?php echo __("Привязан к меню",null); ?></th>
                    <th style="width:5%"><?php echo __("Активность",null); ?>&nbsp;&nbsp;&nbsp;</th>
                </tr>
            </thead>
            <tbody>
                <?php
                if ($menu_elements[0]['id']) :
                foreach ($menu_elements as $material) :?>
                    <tr>
                        <td><?php echo $material['id']; ?></td>
                        <?php foreach ($lang_count as $key => $langs) : $key++;?> 
                            <?php if ($key == '1'): ?>                                    
                                <td><a href="<?php echo URL::base(TRUE,TRUE).'admin/materials/'.$material['id'].'-m/edit';?>"><?php echo $material['title_'.$langs.'']; ?></a></td>
                            <?php else: ?> 
                                <td><?php echo $material['title_'.$langs.'']; ?></td>
                            <?php endif; ?>  
                        <?php endforeach; ?>                                     
                        <td><?php
                            foreach($menu_elements[0]['result_menu'] as $zt)
                            if (in_array($material['menu_id'],$zt)){
                                echo $zt['name_'.$lang.''];
                        ...
                        <td align="center">
                            ...
                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/materials/'.$material['id'].'-m/edit';?>"><img src="<?php echo URL::base().'html/admin/images/pencil.gif"'; ?>" width="16" height="16" /></a>
                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/materials/'.$material['id'].'-m/remove';?>"><img src="<?php echo URL::base().'html/admin/images/cross-on-white.gif"'; ?>" width="16" height="16" /></a>
                        </td>
                    </tr>
                <?php 
                endforeach; 
