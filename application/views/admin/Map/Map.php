...
<div class="float-right">
    <a class="button" href="<?php echo URL::base(TRUE,TRUE).'admin/map/add'; ?>">
<span>
<?php echo __("Новый маркер",null); ?>
...
<br/>
                <!-- Example table -->
                <div class="module">
                	<h2><span><?php echo __("Карта",null); ?></span></h2>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($lang_count as $key => $langs) : $key++;?> 
                                              <?php if ($key == '1'): ?>                                    
                                                    <td><a href="<?php echo URL::base(TRUE,TRUE).'admin/map/'.$material['id'].'-m/edit';?>"><?php echo $material['country_'.$langs.'']; ?></a></td>
                                              <?php else: ?> 
                                                    <td><?php echo $material['country_'.$langs.'']; ?></td>
                                              <?php endif; ?>  
                                        <?php endforeach; ?>                                     
                                        <td align="center">
                                            <img src="<?php echo URL::base().'html/admin/images/status'.$material['status'].'.gif'; ?>" width="16" height="16" />
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/map/'.$material['id'].'-m/edit';?>"><img src="<?php echo URL::base().'html/admin/images/pencil.gif"'; ?>" width="16" height="16" /></a>
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/map/'.$material['id'].'-m/remove';?>"><img src="<?php echo URL::base().'html/admin/images/cross-on-white.gif"'; ?>" width="16" height="16" /></a>
                                        </td>
                                    </tr>
                                <?php 
                                    endforeach;
