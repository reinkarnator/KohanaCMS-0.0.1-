...
<div class="float-right">
    <a class="button" href="<?php echo URL::base(TRUE,TRUE).'admin/Products/add'; ?>">
<span>
<?php echo __("Добавить продукт",null); ?>
...
<br/>
                <!-- Example table -->
                <div class="module">
                	<h2><span><?php echo __("Список продуктов",null); ?></span></h2>
                    ...
                    <div class="module-table-body">
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                ...
                                <?php endforeach; ?>  
                                     <th style="width:21%"><?php echo __("Брэнд",null); ?><?php echo __("Язык".$key."",null); ?></th>                                    
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($lang_count as $key => $langs) : $key++;?> 
                                              <?php if ($key == '1'): ?>                                    
                                                    <td><a href="<?php echo URL::base(TRUE,TRUE).'admin/Products/'.$material['id'].'-m/edit';?>"><?php echo $material['name_'.$langs]; ?></a></td>
                                              <?php else: ?> 
                                                    <td><?php echo $material['name_'.$langs]; ?></td>
                                              <?php endif; ?>  
                                        <?php endforeach; ?>   
                                                    <td><?php echo $material['brand']; ?></td>                                  
                                        <td align="center">
                                            <img src="<?php echo URL::base().'html/admin/images/status'.$material['status'].'.gif'; ?>" width="16" height="16" />
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/Products/'.$material['id'].'-m/edit';?>"><img src="<?php echo URL::base().'html/admin/images/pencil.gif"'; ?>" width="16" height="16" /></a>
                                            <a href="<?php echo URL::base(TRUE,TRUE).'admin/Products/'.$material['id'].'-m/remove';?>"><img src="<?php echo URL::base().'html/admin/images/cross-on-white.gif"'; ?>" width="16" height="16" /></a>
                                        </td>
                                    </tr>
                                <?php 
                                    endforeach;
