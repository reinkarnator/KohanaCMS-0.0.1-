...
class Controller_Admin_Presentations extends Controller_Admin_Common {
...
public function action_index()
{
        ...
        $elems[] = $id;
        $elems[] = HTML::chars($this->request->post('photo'));
        $elems[] = HTML::chars($this->request->post('pdf'));
        $elems[] = HTML::chars($this->request->post('video'));
        ...
        foreach ($lang_count as $langs) {
              ...
              ${'description_'.$langs} = $this->request->post('description_'.$langs);

              $dyn_elems[0][] = ${'name_'.$langs};
              $dyn_elems[1][] = ${'description_'.$langs}; 
        }        
