	...
	public function up()
	{
	    ...
	    $lang_cols['id'] = 'primary_key';
 	    ...
 	    foreach ($langslist as $langs) {
	    	...
	    	$lang_cols['full_'.$langs] = array('string', 'null' => TRUE);
	    	$lang_cols['url_'.$langs] = array('string', 'null' => TRUE);
	    	$lang_cols['smalltext_'.$langs] = array('string', 'null' => TRUE);
	    }

	    $lang_cols['photo'] = array('string', 'null' => FALSE);  
	    $lang_cols['status'] = array('integer', 'null' => FALSE, 'default' => '1');

		$this->create_table( "slider", $lang_cols, array(
				'id' => TRUE,
